...
public class SettingsScreen extends SweetTrackerScreen {
    ...
    private int vgap;
    DiabetesTypeSettingsItem diabetic_type_item;
    ...
    private void initComponents() {
        ...
        PinCodeSettingsItem pincode_item = new PinCodeSettingsItem(w, item_titles[3], item_desc[3], font_title, font_desc, font_title_color, font_desc_color, null, this);
        pincode_item.setEventListener(this);
        addComponent(pincode_item);

        TargetLevelSettingsItem targetLevelSettingsItem = new TargetLevelSettingsItem(w, item_titles[4], item_desc[4], font_title, font_desc, font_title_color, font_desc_color, new Float(settings.getTargetLevel()), this);
