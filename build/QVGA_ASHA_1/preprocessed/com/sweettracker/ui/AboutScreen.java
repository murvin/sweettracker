...
public class AboutScreen extends SweetTrackerScreen {
    ...
    private Image imgApplicationNameTitle, imgApplicationName;
    ...
    private void initResources() {
        ...
        String title = Resources.getInstance().getText(GlobalResources.TXT_ABOUT_APPLICATION_NAME);
        imgApplicationNameTitle = fontTitle.drawStringToImage(title, colourTitle);
        title = UiKitDisplay.midlet.getAppProperty("MIDlet-Name");
        imgApplicationName = fontDesc.drawStringToImage(title);
        imgApplicationName = ImageUtil.replaceColor(imgApplicationName, colourDesc);
    ...
    private void initComponents() {
        ...
        addComponent(new UikitImageBox(0, 0 , imgApplicationNameTitle, titleStyle));
        addComponent(new UikitImageBox(imgApplicationName));
